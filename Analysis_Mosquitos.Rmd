...
ggplot() +
  geom_sf(data = arizona, fill = "white") +
...
##### here i will talk about what i am researching/ analyzing 
...
ccf(cases_2021$cases, cases_2021$average_prcp)
...
Null Hypothesis: Precipitation rates has no affects on the rates of West Nile Virus
cases
